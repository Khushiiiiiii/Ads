                    ...
                    <FormProvider {...methods}>
                        <form onSubmit={methods.handleSubmit(onSubmit)}>
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12}>
                                    <Typography>Landscape Marketing Image</Typography>
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <TextField
                                                {...field}
                                                placeholder="Add URL for landscape marketing image"
                                                fullWidth
                                                variant="outlined"
                                                required
                                            />
                                ...
                                <Grid item xs={12}>
                                    <Typography>Portrait Marketing Image</Typography>
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <TextField
                                                {...field}
                                                placeholder="Add URL for portrait marketing image"
                                                fullWidth
                                                variant="outlined"
                                                required
                                            />
                                ...
                                <Grid item xs={12}>
                                    <Typography>Square Marketing Image</Typography>
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <TextField
                                                {...field}
                                                placeholder="Add URL for square marketing image"
                                                fullWidth
                                                variant="outlined"
                                                required
                                            />
                            ...
                            <Grid container spacing={3} mt={2}>
                                ...
                                <Grid item xs={12} md={6} display={'flex'} spacing={2}>
